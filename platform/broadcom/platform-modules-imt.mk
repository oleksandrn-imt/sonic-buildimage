...
$(BCM_IMT_BK_MODULES)_URL = "https://github.com/InterfaceMasters/sonic-release-pkgs/raw/imt-bcm-sai-5.0.0.12/sonic-imt-boardkeeper-pkgs/$(BCM_IMT_BK_MODULES)"
...
$(BCM_IMT_BK_UTILS)_URL = "https://github.com/InterfaceMasters/sonic-release-pkgs/raw/imt-bcm-sai-5.0.0.12/sonic-imt-boardkeeper-pkgs/$(BCM_IMT_BK_UTILS)"
...
$(BCM_IMT_BK_UTILS_CFG)_URL = "https://github.com/InterfaceMasters/sonic-release-pkgs/raw/imt-bcm-sai-5.0.0.12/sonic-imt-boardkeeper-pkgs/$(BCM_IMT_BK_UTILS_CFG)"
...
$(IMT_FANCONTROL_CFG)_URL = "https://github.com/InterfaceMasters/sonic-release-pkgs/raw/imt-bcm-sai-5.0.0.12/sonic-imt-boardkeeper-pkgs/$(IMT_FANCONTROL_CFG)"
SONIC_ONLINE_DEBS += $(IMT_FANCONTROL_CFG)

IMT_SENSORS_CFG = sensors-config_3.01_amd64.deb
$(IMT_SENSORS_CFG)_URL = "https://github.com/InterfaceMasters/sonic-release-pkgs/raw/imt-bcm-sai-5.0.0.12/sonic-imt-boardkeeper-pkgs/$(IMT_SENSORS_CFG)"
