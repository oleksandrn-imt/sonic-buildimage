...
if [ "$install_env" = "onie" ]; then
    ...
    # TODO: Right location should be handled by our ONIE
    #onie_root_dir=/mnt/onie-boot/onies
...
DEFAULT_GRUB_CMDLINE_LINUX="pnpacpi=off intel_iommu=on console=tty0 console=ttyS${CONSOLE_DEV},${CONSOLE_SPEED}n8 quiet"
